...
const ListingDetail = () => {
  ...
  return (
    <main className='flex 2xl:p-10 lg:justify-start lg:gap-5 '>
      <div className='xl:w-[70%] lg:w-[80%] lg:p-10 bg-white rounded-xl shadow-2xl '>
        <section className='flex flex-col gap-5 lg:p-5'>
          ...
          <div className='flex xl:flex-row lg:flex-row lg:justify-start lg:items-start lg:gap-5'>
            {listingDetails?.images?.map((thumbnail, index) => {
              return (
                <Image
                  ...
                  width={200}
                  height={200}
                  className={`rounded-lg cursor-pointer object-cover lg:w-[100px] lg:h-[80px] ${
          ...
          <article className='flex lg:flex-col lg:gap-4'>
            <div className='flex lg:justify-between lg:items-start'>
              <h1 className='2xl:text-4xl 2xl:w-[60%] lg:w-[70%] md:w-[80%] sm:w-full '>
            ...
            <div className='flex lg:justify-between lg:items-center lg:w-[30%] '>
            ...
            <article className='flex flex-col gap-3'>
              <h1 className='lg:text-2xl font-semibold '>Description</h1>
              <p className=''>{listingDetails.description}</p>
            </article>
          </article>
        </section>
      </div>
      <section className='bg-white shadow-2xl rounded-xl flex flex-col gap-5 2xl:p-10 2xl:w-[30%]   '>
        <header className='flex gap-4'>
          <Image
            ...
            width={500}
            height={500}
            className='object-cover rounded-full border-black p-1 2xl:w-[70px] 2xl:h-[70px] lg:h-[450px] '
          />
          <div className='flex flex-col gap-2'>
            <h1 className='2xl:text-2xl lg:text-2xl font-semibold '>
        ...
        <p className=''>
          ...
          needs. I know that buying or selling a home is a big decision, and I'm
          committed to providing my clients with the best possible service. I'll
          work with you every step of the way, from finding the right home to
          closing the deal. I'll also make sure you understand all of your
          options and that you're getting the best possible price for your home.
          I'm a member of the National Association of Realtors, and I'm
          committed to upholding the highest ethical standards in the real
          estate industry. I'm also a certified buyer's agent and a certified
          seller's agent, which means that I have the training and experience to
          help you with your real estate needs. If you're looking for a real
          estate agent who will work hard to get you the best possible outcome,
          I'm the agent for you. Contact me today to schedule a consultation.
        </p>
