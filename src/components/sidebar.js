...
const SideBarNavigation = () => {
  ...
  return (
    <main
      className='2xl:w-[18%] 2xl:flex xl:w-[18%] xl:flex lg:w-[18%] lg:flex md:hidden sm:hidden py-10 h-screen bg-white p-5 
     flex-col justify-between items-start fixed top-0 left-0   '
    >
      <Link
        href={'/'}
